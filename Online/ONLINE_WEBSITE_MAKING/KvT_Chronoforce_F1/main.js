...
`),
    ...
    var Wd, Gd, Xd = R( () => {
        ...
        Gd = [{
            ...
            mobile: ["./assets/images/desktop/hero.webp"]
        }, {
            key: "sport",
    ...
    var ub = Qp(Yp => {
        ...
        var ja;
        window.matchMedia("(min-width: 768px)").matches && document.querySelector(".ambienceSoundToggle") && (ja = new tp("./phonk.mp3",".ambienceSoundToggle"));
        var oi;
